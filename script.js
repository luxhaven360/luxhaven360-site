...
function createProductCard(prod, defaultCta) {
    ...
    const targetUrl = `${base}?sku=${sku}&section=${section}`;
    window.location.href = `assets/loading_screen/luxhaven-loading.html?target=${encodeURIComponent(targetUrl)}`;
});
