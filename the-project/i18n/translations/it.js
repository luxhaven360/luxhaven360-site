...
// Auto-extended: complete i18n v2
Object.assign(window.I18N_TRANSLATIONS['it'], {
  'time.now':'Ora','time.min_ago':'{n}m fa','time.hour_ago':'{n}h fa','time.day_ago':'{n}g fa','time.yesterday':'Ieri',
  'feed.type.update':'📢 Aggiornamento','feed.type.exclusive':'⭐ Contenuto Esclusivo','feed.type.event':'📅 Evento','feed.type.news':'📰 Notizia',
  ...
  'feed.locked_btn':'Sblocca come Founding Member','feed.like':'Mi piace','feed.liked':'Liked',
  'feed.comment_btn':'Commenta','feed.share':'Condividi','feed.report':'Segnala',
  'feed.comment_placeholder':'Scrivi un commento…','feed.like_toast':'Hai messo like al post!',
  'feed.empty':'Nessun aggiornamento disponibile.','feed.empty_sub':'Il team pubblicherà presto il primo contenuto.',
  'feed.activity_cleared':'Attività recente svuotata per te',
  'survey.active_tag':'📊 Sondaggio Attivo','survey.vote_cta':'Vota per vedere i risultati','survey.voted':'✓ Hai già votato',
  'survey.total_one':'{n} voto totale','survey.total':'{n} voti totali',
  'dash.members_up':'+{n} questa settimana','dash.members_down':'-{lost} usciti, +{new} nuovi questa settimana',
  'dash.members_nochange':'Nessuna variazione questa settimana','dash.of_n_spots':'su {n} posti totali',
  'dash.slot_one':'Slot disponibile','dash.all_spots_full':'Tutti i posti esauriti',
  'dash.spots_remaining_one':'{n} posto ancora disponibile','dash.spots_remaining':'{n} posti ancora disponibili',
  'dash.spots_left_one':'{n} rimasto','dash.spots_left':'{n} rimasti',
  'analytics.first_session':'Prima sessione del giorno','analytics.up_vs_yesterday':'+{pct}% vs ieri',
  'analytics.down_vs_yesterday':'{pct}% vs ieri','analytics.no_data':'Dati insufficienti',
  'analytics.growing_vs_week':'↑ in crescita vs settimana prec.','analytics.up_pct_vs_week':'+{pct}% vs settimana prec.',
  'analytics.down_pct_vs_week':'{pct}% vs settimana prec.','analytics.stable_vs_week':'→ Stabile vs settimana prec.',
  'analytics.growing':'↑ In crescita','analytics.declining':'↓ In calo','analytics.stable':'→ Stabile',
  'analytics.in_feed':'{n} nel feed','analytics.total_reply':'{n} risposta totale','analytics.total_replies':'{n} risposte totali',
  'analytics.none_pending':'✅ Nessuna pendente','analytics.to_manage':'{n} da gestire',
  ...
  'broadcast.recipient.all':'Tutti i membri','broadcast.recipient.founding':'Founding Members',
  'broadcast.recipient.candidate':'Founder Candidates','broadcast.visible_to':'Visibile a:',
  'disc.replies_one':'{n} risposta','disc.replies':'{n} risposte','disc.views_one':'{n} visualizzazione','disc.views':'{n} visualizzazioni',
  'notif.type.project_updates':'aggiornamenti progetto','notif.type.direct_messages':'messaggi diretti',
  'notif.type.new_listings':'nuovi listing','notif.type.new_surveys':'nuovi sondaggi',
  'notif.type.discussion_reply':'risposte ai thread','notif.type.mention_reply':'menzioni',
  'notif.enabled':'abilitate','notif.disabled':'disabilitate',
